...
"""
    ...
    def setUpClass(cls):
        ...
        os.system("$PDNSUTIL --config-dir=configs/auth replace-rrset example.net . SOA 3600 'ns1.example.net otto.example.net 2022010403 10800 3600 604800 3600'")
        os.system("$PDNSUTIL --config-dir=configs/auth replace-rrset noacceptor.net . SOA 3600 'ns1.noacceptor.net otto.example.net 2022010403 10800 3600 604800 3600'")
        os.system("$PDNSUTIL --config-dir=configs/auth replace-rrset wrongacceptor.net . SOA 3600 'ns1.wrongacceptor.net otto.example.net 2022010403 10800 3600 604800 3600'")

...
private:
  ...
  static string DLDomStatusHandler(const vector<string>& parts, pid_t ppid, Logr::log_t slog);
  static string DLDomExtendedStatusHandler(const vector<string>& parts, pid_t ppid, Logr::log_t slog);
  static string DLListRejectsHandler(const vector<string>& parts, pid_t ppid, Logr::log_t slog);
  static string DLReloadNowHandler(const vector<string>& parts, pid_t ppid, Logr::log_t slog);
  static string DLAddDomainHandler(const vector<string>& parts, pid_t ppid, Logr::log_t slog);

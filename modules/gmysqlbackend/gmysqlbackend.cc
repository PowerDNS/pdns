...
public:
  ...
  gMySQLLoader()
  {
    ...
    SLOG(g_log << Logger::Info << "[gmysqlbackend] This is the gmysql backend version " VERSION
#ifndef REPRODUCIBLE
               << " (" __DATE__ " " __TIME__ ")"
#endif
               << " reporting" << endl,
         g_slog->withName("gmysqlbackend")->info(Logr::Info, "gmysql backend starting", "version", Logging::Loggable(VERSION)
#ifndef REPRODUCIBLE
                                                                                                     ,

...
public:
  ...
  struct EDNSStatus
  {
    ...
    ComboAddress address;
    time_t modeSetAt{0};
    mutable enum EDNSMode { UNKNOWN = 0,
      EDNSOK = 1,
      EDNSIGNORANT = 2,
      NOEDNS = 3 } mode{UNKNOWN};
  };
...
private:
  ...
  struct GetBestNSAnswer
  {
    ...
    {
      return boost::tie(qtype, qname, bestns) < boost::tie(b.qtype, b.qname, b.bestns);
    }
  };

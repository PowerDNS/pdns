...
struct DNSDistStats
{
  ...
  std::vector<std::tuple<std::string, entry_t, std::string, std::string>> entries{
    std::make_tuple("responses", &responses, "counter", "Number of responses received from backends"),
    std::make_tuple("servfail-responses", &servfailResponses, "counter", "Number of SERVFAIL answers received from backends"),
    std::make_tuple("queries", &queries, "counter", "Number of received queries"),
    std::make_tuple("acl-drops", &aclDrops, "counter", "Number of packets dropped because of the ACL"),
    std::make_tuple("rule-drop", &ruleDrop, "counter", "Number of queries dropped because of a rule"),
    std::make_tuple("rule-nxdomain", &ruleNXDomain, "counter", "Number of NXDomain answers returned because of a rule"),
    std::make_tuple("rule-refused", &ruleRefused, "counter", "Number of Refused answers returned because of a rule"),
    std::make_tuple("rule-servfail", &ruleServFail, "counter", "Number of SERVFAIL answers received because of a rule"),
    std::make_tuple("self-answered", &selfAnswered, "counter", "Number of self-answered responses"),
    std::make_tuple("downstream-timeouts", &downstreamTimeouts, "counter", "Number of queries not answered in time by a backend"),
    std::make_tuple("downstream-send-errors", &downstreamSendErrors, "counter", "Number of errors when sending a query to a backend"),
    std::make_tuple("trunc-failures", &truncFail, "counter", "Number of errors encountered while truncating an answer"),
    std::make_tuple("no-policy", &noPolicy, "counter", "Number of queries dropped because no server was available"),
    std::make_tuple("latency0-1", &latency0_1, "counter", "Number of queries answered in less than 1ms"),
    std::make_tuple("latency1-10", &latency1_10, "counter", "Number of queries answered in 1-10 ms"),
    std::make_tuple("latency10-50", &latency10_50, "counter", "Number of queries answered in 10-50 ms"),
    std::make_tuple("latency50-100", &latency50_100, "counter", "Number of queries answered in 50-100 ms"),
    std::make_tuple("latency100-1000", &latency100_1000, "counter", "Number of queries answered in 100-1000 ms"),
    std::make_tuple("latency-slow", &latencySlow, "counter", "Number of queries answered in more than 1 second"),
    std::make_tuple("latency-avg100", &latencyAvg100, "gauge", "Average response latency in microseconds of the last 100 packets"),
    std::make_tuple("latency-avg1000", &latencyAvg1000, "gauge", "Average response latency in microseconds of the last 1000 packets"),
    std::make_tuple("latency-avg10000", &latencyAvg10000, "gauge", "Average response latency in microseconds of the last 10000 packets"),
    std::make_tuple("latency-avg1000000", &latencyAvg1000000, "gauge", "Average response latency in microseconds of the last 1000000 packets"),
    std::make_tuple("uptime", uptimeOfProcess, "gauge", "Uptime of the dnsdist process in seconds"),
    std::make_tuple("real-memory-usage", getRealMemoryUsage, "gauge", "Current memory usage in bytes"),
    std::make_tuple("noncompliant-queries", &nonCompliantQueries, "counter", "Number of queries dropped as non-compliant"),
    std::make_tuple("noncompliant-responses", &nonCompliantResponses, "counter", "Number of answers from a backend dropped as non-compliant"),
    std::make_tuple("rdqueries", &rdQueries, "counter", "Number of received queries with the recursion desired bit set"),
    std::make_tuple("empty-queries", &emptyQueries, "counter", "Number of empty queries received from clients"),
    std::make_tuple("cache-hits", &cacheHits, "counter", "Number of times an answer was retrieved from cache"),
    std::make_tuple("cache-misses", &cacheMisses, "counter", "Number of times an answer not found in the cache"),
    std::make_tuple("cpu-user-msec", getCPUTimeUser, "counter", "Milliseconds spent by dnsdist in the user state"),
    std::make_tuple("cpu-sys-msec", getCPUTimeSystem, "counter", "Milliseconds spent by dnsdist in the system state"),
    std::make_tuple("fd-usage", getOpenFileDescriptors, "gauge", "Number of currently used file descriptors"),
    std::make_tuple("dyn-blocked", &dynBlocked, "counter", "Number of queries dropped because of a dynamic block"),
    std::make_tuple("dyn-block-nmg-size", [](const std::string&) { return g_dynblockNMG.getLocal()->size(); }, "gauge", "Number of dynamic blocks entries"),
  };
};

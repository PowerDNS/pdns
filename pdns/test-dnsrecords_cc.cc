...
#define REC_CHECK_MESSAGE(cond, msg)                        \
  {                                                         \
    if (broken_marker::BROKEN == broken) {                  \
      BOOST_WARN_MESSAGE(cond, "Failed to verify " << msg); \
    }                                                       \
    else {                                                  \
      BOOST_CHECK_MESSAGE(cond, msg);                       \
    }                                                       \
  }
#define REC_FAIL_XSUCCESS(msg)                                                         \
  {                                                                                    \
    if (broken_marker::BROKEN == broken) {                                             \
      BOOST_CHECK_MESSAGE(false, std::string("Test has unexpectedly passed: ") + msg); \
    }                                                                                  \
  } // fail if test succeeds
...
BOOST_AUTO_TEST_CASE(test_record_types)
{
  ...
  const cases_t cases = boost::assign::list_of(CASE_S(QType::A, "127.0.0.1", "\x7F\x00\x00\x01"))
    // local nameserver
    (CASE_S(QType::NS, "ns.rec.test.", "\x02ns\xc0\x11"))
    // non-local nameserver
    (CASE_S(QType::NS, "ns.example.com.", "\x02ns\x07"
                                          "example\x03"
                                          "com\x00"))
    // local alias
    (CASE_S(QType::CNAME, "name.rec.test.", "\x04name\xc0\x11"))
    // non-local alias
    (CASE_S(QType::CNAME, "name.example.com.", "\x04name\x07"
                                               "example\x03"
                                               "com\x00"))
    // max label length (63)
    (CASE_S(QType::CNAME, "123456789012345678901234567890123456789012345678901234567890123.example.com.", "\x3f"
                                                                                                          "123456789012345678901234567890123456789012345678901234567890123\x07"
                                                                                                          "example\x03"
                                                                                                          "com\x00"))
    // local max name length (255)
    (CASE_S(QType::CNAME, "123456789012345678901234567890123456789012345678901234567890123.123456789012345678901234567890123456789012345678901234567890123.123456789012345678901234567890123456789012345678901234567890123.1234567890123456789012345678901234567890123456789012.rec.test.", "\x3f"
                                                                                                                                                                                                                                                                                            "123456789012345678901234567890123456789012345678901234567890123\x3f"
                                                                                                                                                                                                                                                                                            "123456789012345678901234567890123456789012345678901234567890123\x3f"
                                                                                                                                                                                                                                                                                            "123456789012345678901234567890123456789012345678901234567890123\x34"
                                                                                                                                                                                                                                                                                            "1234567890123456789012345678901234567890123456789012\xc0\x11"))
    // non-local max name length (255)
    (CASE_S(QType::CNAME, "123456789012345678901234567890123456789012345678901234567890123.123456789012345678901234567890123456789012345678901234567890123.123456789012345678901234567890123456789012345678901234567890123.1234567890123456789012345678901234567890123456789012345678901.", "\x3f"
                                                                                                                                                                                                                                                                                            "123456789012345678901234567890123456789012345678901234567890123\x3f"
                                                                                                                                                                                                                                                                                            "123456789012345678901234567890123456789012345678901234567890123\x3f"
                                                                                                                                                                                                                                                                                            "123456789012345678901234567890123456789012345678901234567890123\x3d"
                                                                                                                                                                                                                                                                                            "1234567890123456789012345678901234567890123456789012345678901\x00"))
    // local names
    ...
    // non-local names
    (CASE_S(QType::SOA, "ns.example.com. hostmaster.example.com. 2013051201 3600 3600 604800 120", "\x02ns\x07"
                                                                                                   "example\x03"
                                                                                                   "com\x00\x0ahostmaster\xc0\x28\x77\xfc\xb9\x41\x00\x00\x0e\x10\x00\x00\x0e\x10\x00\x09\x3a\x80\x00\x00\x00\x78"))

    // local name
    (CASE_S(QType::MR, "newmailbox.rec.test.", "\x0anewmailbox\xc0\x11"))
    // non-local name
    (CASE_S(QType::MR, "newmailbox.example.com.", "\x0anewmailbox\x07"
                                                  "example\x03"
                                                  "com\x00"))
    ...
    // non-local name
    (CASE_S(QType::PTR, "ptr.example.com.", "\x03ptr\x07"
                                            "example\x03"
                                            "com\x00"))(CASE_S(QType::HINFO, "\"i686\" \"Linux\"", "\x04i686\x05Linux"))(BROKEN_CASE_L(QType::HINFO, "i686 \"Linux\"", "\"i686\" \"Linux\"", "\x04i686\x05Linux"))(CASE_L(QType::HINFO, "\"i686\" Linux", "\"i686\" \"Linux\"", "\x04i686\x05Linux"))(BROKEN_CASE_L(QType::HINFO, "i686 Linux", "\"i686\" \"Linux\"", "\x04i686\x05Linux"))
    // local name
    (CASE_S(QType::MX, "10 mx.rec.test.", "\x00\x0a\x02mx\xc0\x11"))
    // non-local name
    (CASE_S(QType::MX, "20 mx.example.com.", "\x00\x14\x02mx\x07"
                                             "example\x03"
                                             "com\x00"))
    // root label
    (CASE_S(QType::MX, "20 .", "\x00\x14\x00"))

      (CASE_S(QType::TXT, "\"short text\"", "\x0ashort text"))(CASE_S(QType::TXT, "\"long record test 1111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111\" \"2222222222\"", "\xff"
                                                                                                                                                                                                                                                                                                                                                                        "long record test 1111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111\x0a"
                                                                                                                                                                                                                                                                                                                                                                        "2222222222"))(CASE_L(QType::TXT, "\"long record test 11111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111112222222222\"", "\"long record test 1111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111\" \"2222222222\"", "\xff"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 "long record test 1111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111\x0a"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 "2222222222"))(CASE_S(QType::TXT, "\"\\195\\133LAND ISLANDS\"", "\x0e\xc3\x85LAND ISLANDS"))(CASE_S(QType::TXT, "\"text with DEL in there: \\127\"", "\x19text with DEL in there: \x7f"))(CASE_L(QType::TXT, "\"\xc3\x85LAND ISLANDS\"", "\"\\195\\133LAND ISLANDS\"", "\x0e\xc3\x85LAND ISLANDS"))(CASE_S(QType::TXT, "\"nonbreakingtxt\"", "\x0enonbreakingtxt"))
    // local name
    (CASE_S(QType::RP, "admin.rec.test. admin-info.rec.test.", "\x05"
                                                               "admin\x03rec\x04test\x00\x0a"
                                                               "admin-info\x03rec\x04test\x00"))
    // non-local name
    (CASE_S(QType::RP, "admin.example.com. admin-info.example.com.", "\x05"
                                                                     "admin\x07"
                                                                     "example\x03"
                                                                     "com\x00\x0a"
                                                                     "admin-info\x07"
    ...
    (CASE_L(QType::RRSIG, "SOA 8 3 300 1369267200 1368057600 54216 rec.test. ecWKD/OsdAiXpbM/sgPT82KVD/WiQnnqcxoJgiH3ixHa+LOAcYU7FG7V4BRRJxLriY1e0rB2gAs3kCel9D4bzfK6wAqG4Di/eHUgHptRlaR2ycELJ4t1pjzrnuGiIzA1wM2izRmeE+Xoy1367Qu0pOz5DLzTfQITWFsB2iUzN4Y=", "SOA 8 3 300 20130523000000 20130509000000 54216 rec.test. ecWKD/OsdAiXpbM/sgPT82KVD/WiQnnqcxoJgiH3ixHa+LOAcYU7FG7V4BRRJxLriY1e0rB2gAs3kCel9D4bzfK6wAqG4Di/eHUgHptRlaR2ycELJ4t1pjzrnuGiIzA1wM2izRmeE+Xoy1367Qu0pOz5DLzTfQITWFsB2iUzN4Y=", ""))(CASE_S(QType::NSEC, "a.rec.test. A NS SOA MX AAAA RRSIG NSEC DNSKEY", "\x01"
      ...
      (CASE_S(QType::DHCID, "AAAB92JtyyO73zqENgu9LVua+0PZoeCcKapTw4asbYmx5F4=", "\x00\x00\x01\xf7\x62\x6d\xcb\x23\xbb\xdf\x3a\x84\x36\x0b\xbd\x2d\x5b\x9a\xfb\x43\xd9\xa1\xe0\x9c\x29\xaa\x53\xc3\x86\xac\x6d\x89\xb1\xe4\x5e"))(CASE_S(QType::DHCID, "AAEB92JtyyO73zqENgu9LVua+0PZoeCcKapTw4asbYmx5F4=", "\x00\x01\x01\xf7\x62\x6d\xcb\x23\xbb\xdf\x3a\x84\x36\x0b\xbd\x2d\x5b\x9a\xfb\x43\xd9\xa1\xe0\x9c\x29\xaa\x53\xc3\x86\xac\x6d\x89\xb1\xe4\x5e"))(CASE_S(QType::DHCID, "AAIB92JtyyO73zqENgu9LVua+0PZoeCcKapTw4asbYmx5F4=", "\x00\x02\x01\xf7\x62\x6d\xcb\x23\xbb\xdf\x3a\x84\x36\x0b\xbd\x2d\x5b\x9a\xfb\x43\xd9\xa1\xe0\x9c\x29\xaa\x53\xc3\x86\xac\x6d\x89\xb1\xe4\x5e"))

        (CASE_S(QType::NSEC3, "1 1 1 f00b RPF1JGFCCNFA7STPTIJ9FPFNM40A4FLL NS SOA RRSIG DNSKEY NSEC3PARAM", "\x01\x01\x00\x01\x02\xf0\x0b\x14\xde\x5e\x19\xc1\xec\x65\xde\xa3\xf3\xb9\xec\xa6\x97\xe5\xf7\xb1\x00\xa2\x3e\xb5\x00\x07\x22\x00\x00\x00\x00\x02\x90"))(CASE_S(QType::NSEC3PARAM, "1 0 1 f00b", "\x01\x00\x00\x01\x02\xf0\x0b"))
...
#define BROKEN_WIRE_CASE(type, input) case_t(type, BINARY(input), case_type_t::wire, broken_marker::BROKEN)
  ...
  const cases_t cases = boost::assign::list_of(ZONE_CASE(QType::A, "932.521.256.42")) // hollywood IP
  ...
  for (const cases_t::value_type& val : cases) {
    ...
    if (broken_marker::BROKEN == broken) {
      ...
      if (success)
        REC_FAIL_XSUCCESS(q.getName() << " test #" << n << " has unexpectedly passed"); // a bad record was detected when it was supposed not to be detected
    }
    else {
...
BOOST_AUTO_TEST_CASE(test_opt_record_in)
{
  ...
  std::string packet("\xf0\x01\x01\x00\x00\x01\x00\x01\x00\x00\x00\x01\x03www\x08powerdns\x03"
                     "com\x00\x00\x01\x00\x01\x03www\x08powerdns\x03"
                     "com\x00\x00\x01\x00\x01\x00\x00\x00\x10\x00\x04\x7f\x00\x00\x01\x00\x00\x29\x05\x00\x00\x00\x00\x00\x00\x0c\x00\x03\x00\x08powerdns",
    89);
...
BOOST_AUTO_TEST_CASE(test_opt_record_out)
{
  ...
  std::string packet("\xf0\x01\x01\x00\x00\x01\x00\x01\x00\x00\x00\x01\x03www\x08powerdns\x03"
                     "com\x00\x00\x01\x00\x01\xc0\x0c\x00\x01\x00\x01\x00\x00\x00\x10\x00\x04\x7f\x00\x00\x01\x00\x00\x29\x05\x00\x00\x00\x00\x00\x00\x0c\x00\x03\x00\x08powerdns",
    73);

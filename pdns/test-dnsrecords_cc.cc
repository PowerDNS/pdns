...
BOOST_AUTO_TEST_CASE(test_record_types_bad_values) {
  ...
  cases_t cases = boost::assign::list_of
     ...
     (case_t(QType::PTR, "1234567890123456789012345678901234567890.1234567890123456789012345678901234567890.1234567890123456789012345678901234567890.1234567890123456789012345678901234567890.1234567890123456789012345678901234567890.1234567890123456789012345678901234567890.1234567890123456789012345678901234567890", zone, false)) // total size of name too large
     (case_t(QType::PTR, "12345678901234567890123456789012345678901234567890123456789012345678901234567890.powerdns.com", zone, false)) // Label too long
;

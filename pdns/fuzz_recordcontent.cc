...
static const std::array<uint16_t, 48> g_qtypes{
  ...
  QType::RRSIG,  QType::SIG,    QType::KEY,    QType::DNSKEY,
  QType::CDNSKEY,QType::DS,     QType::CDS,    QType::DLV,
  QType::NSEC,   QType::NSEC3,  QType::NSEC3PARAM, QType::TLSA,
  QType::SMIMEA, QType::SVCB,   QType::HTTPS,  QType::CAA,
  QType::NAPTR,  QType::LOC,    QType::APL,    QType::CERT,
  QType::SSHFP,  QType::IPSECKEY, QType::DHCID, QType::OPENPGPKEY,
  QType::CSYNC,  QType::ZONEMD, QType::URI,    QType::DNAME,
  QType::KX,     QType::SPF,    QType::EUI48,  QType::EUI64,
  QType::NID,    QType::L32,    QType::L64,    QType::LP,
};

...
struct SendReceive
{
  ...
  Identifier send(TypedQuery& domain, int /*cookie*/)
  {
  ...
  bool receive(Identifier& iden, DNSResult& dnsResult, int /*cookie*/)
  {
  ...
  void deliverAnswer(TypedQuery& domain, const DNSResult& dnsResult, unsigned int usec, int /*cookie*/)
  {
    (*d_acc)(usec / 1000.0);
    //  if(usec > 1000000)

...
private:
  ...
  */
  ...
  bool entryMatches(OrderedTagIterator_t& entry, uint16_t qt, bool requireAuth, const OptTag& rtag);
  std::pair<NameOnlyHashedTagIterator_t, NameOnlyHashedTagIterator_t> getEntries(MapCombo& map, const DNSName &qname, const QType& qt, const OptTag& rtag);

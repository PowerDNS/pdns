...
string DLRespSizeHandler(const vector<string>&parts, pid_t ppid, Logr::log_t slog);
...
string DLTokenLogin(const vector<string>&parts, pid_t ppid, Logr::log_t slog);
...
string DLManageCookieSecret(const vector<string>&parts, pid_t ppid, Logr::log_t slog);

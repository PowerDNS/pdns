...
public:
  ...
  bool superMasterAdd(const SuperMaster &master);
  bool superMasterRemove(const struct SuperMaster& master);
  bool superMastersList(std::vector<SuperMaster>& masters);

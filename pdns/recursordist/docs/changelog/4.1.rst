...
.. changelog::
  ...
  The third Release Candidate contains …
  - a cleaned up web UI
  ...
  .. change::
    ...
    Print more details of trust anchors. In addition, the :ref:`--trace`
    output that mentions if data from authoritative servers gets
    accepted now also prints the TTL and clarifies the 'place' number
    previously printed.

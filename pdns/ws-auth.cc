...
// etc).
static void replaceZoneRecords(DomainInfo& domainInfo, const DNSName& zonename, vector<DNSResourceRecord>& new_records, const DNSName& qname, const QType qtype)
{

...
struct SendReceive
{
  ...
  Identifier send(NSQuery& domain, int /*cookie*/)
  {
  ...
  bool receive(Identifier& id, DNSResult& dr, int /*cookie*/)
  {
  ...
  void deliverAnswer(NSQuery& domain, const DNSResult& dr, unsigned int usec, int /*cookie*/)
  {
...
struct SendReceiveRes
{
  ...
  Identifier send(RESQuery& domain, int /*cookie*/)
  {
    //cerr<<"Sending query for '"<<domain<<"'"<<endl;
  ...
  bool receive(Identifier& id, RESResult& dr, int /*cookie*/)
  {
    if(waitForData(d_socket, 0, 500) > 0) {
      char buf[512];
      ComboAddress from;
  ...
  void deliverAnswer(DNSName& domain, const RESResult& dr, unsigned int usec, int /*cookie*/)
  {

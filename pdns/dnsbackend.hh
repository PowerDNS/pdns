...
public:
  ...
  virtual void lookup(const QType &qtype, const DNSName &qdomain, vector<DNSResourceRecord> &rrs, int zoneId=-1, DNSPacket *pkt_p=nullptr)=0;
  virtual void lookup(const QType &qtype, const DNSName &qdomain, vector<DNSZoneRecord> &rrs, int zoneId=-1, DNSPacket *pkt_p=nullptr);

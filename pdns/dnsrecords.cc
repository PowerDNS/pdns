...
{
  return std::shared_ptr<DRIPBaseRecordContent>(std::make_shared<HHITRecordContent>(*this));
}

std::shared_ptr<DRIPBaseRecordContent> BRIDRecordContent::clone() const
{
  return std::shared_ptr<DRIPBaseRecordContent>(std::make_shared<BRIDRecordContent>(*this));
}

...
class TestCacheManagement(DNSDistTest):
    ...
    def testCacheExpungeByMultipleName(self):
        ...
        # remove cached entries from name
        self.sendConsoleCommand('getPool(""):getCache():expungeByName({newDNSName("' + name + '"), newDNSName("' + name2 + '")})')
    ...
    def testCacheExpungeByNamesAndSuffix(self):
        ...
        # remove cached entries from name
        self.sendConsoleCommand("getPool(\"\"):getCache():expungeByName({newDNSName(\"suffix-names.cache.tests.powerdns.com.\")}, DNSQType.ANY, true)")
    ...
    def testCacheExpungeByNamesAndTypeAndSuffix(self):
        ...
        # remove cached entries from name A
        self.sendConsoleCommand("getPool(\"\"):getCache():expungeByName({newDNSName(\"suffixnamestype.cache.tests.powerdns.com.\")}, DNSQType.A, true)")

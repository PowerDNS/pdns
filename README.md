...
This repository contains the sources for the PowerDNS Recursor, for the PowerDNS Authoritative Server,
and the PowerDNS dnsdist load balancer. All three can be built from this repository. All are released
separately as .tar.bz2, .deb and .rpm however!

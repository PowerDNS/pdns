...
.. changelog::
  ...
  .. change::
    ...
    Fix invalid SOA record in MySQL crashing the server.
  ...
  .. change::
    ...
    Use a less expensive way to get memory stats for ``rel-memory-usage``.
  ...
  .. change::
    ...
    Fix compilation of speedtest with GCC 8.0+.
  ...
  .. change::
    ...
    Fix Zone Masters being set wrong via REST API.

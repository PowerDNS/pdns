...
.. changelog::
  ...
  It contains [blinding lights].

  .. change::
    :tags: New Features
    :pullreq: 15393, 15441, 15421, 15470, 15512

    views [more words here]
  ...
  .. change::
    ...
    try to find ldap libs in case pkconfig is missing (happens on debian11)
  ...
  .. change::
    ...
    don't log absense of GSS-TSIG functionality at such a high level, use DEBUG

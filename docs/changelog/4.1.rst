...
.. changelog::
  ...
  Ofcourse, this release also includes corrected typos, improvements to
  the documentation and a lot of minor improvements of issues discovered
  by @jpmens!

  Thanks to everyone who tested Release Candidate 1 of the Authoritative
  Server.
  ...
  .. change::
    ...
    Before, we did not follow :rfc:`6891` section 6.2.3 correctly.
  ...
  .. change::
    ...
    …``. This was not only inconsistent behaviour but also done
    incorrectly.
  ...
  .. change::
    ...
    Fix issues when migrating from the BIND backend to gsqlite3:

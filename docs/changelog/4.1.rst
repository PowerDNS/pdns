...
.. changelog::
  :version: 4.1.0
  :released: 29th of November 2017

  This is the first release in the 4.1.x train.

  The full release notes can be read at: https://wordpress.com/post/blog.powerdns.com/2473
  ...
  And, while we recognize this has an impact on many installations and may be painful, it was necessary to remove support for Recursor passthrough.  To read more about this please see the blog post mentioned above.

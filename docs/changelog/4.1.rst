...
.. changelog::
  ...
  And, while we recognize this has an impact on many installations and may be painful, it was necessary to remove support for Recursor passthrough.  To read more about this please see the blog post mentioned above or read the :doc:`migration guide <../../guides/recursion>`.

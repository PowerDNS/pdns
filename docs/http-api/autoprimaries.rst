...
An autoprimary object represents single autoprimary server.
...
.. code-block:: http
  ...
  [{"ip":"1.2.3.4","nameserver":"ns.example.com","account":""},{"ip":"4.3.2.1","nameserver":"ns.example.org","account":"example"}]
...
.. code-block:: http
  ...
  {"ip":"1.2.3.4","nameserver","ns.example.com","account":""}
...
.. code-block:: http
  ...
  DELETE /servers/localhost/autoprimaries/1.2.3.4/ns.example.com HTTP/1.1
  X-Api-Key: secret
  Content-Type: application/json

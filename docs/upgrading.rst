...
If your backend is dynamic in what zones it does or does not offer, and thus cannot easily provide a completely list of zones every few minutes, set the interval to 0 to disable the feature.
